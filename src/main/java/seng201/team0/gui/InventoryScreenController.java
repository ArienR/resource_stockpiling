...
public class InventoryScreenController {
    ...
    @FXML private Label inventorySelectedTowerCollectionAmountLabel;
    @FXML private Label inventorySelectedTowerCollectionSpeedLabel;
    ...
    @FXML private Label inventorySelectedItemNameLabel, inventorySelectedItemTypeLabel, inventorySelectedItemStatLabel;
